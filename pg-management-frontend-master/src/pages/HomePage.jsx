        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <div className="col-md-4">
              <div className="card p-3">
                <p>
                  "Listing my property was quick and straightforward. I've
                  received so many bookings already!"
                </p>
                <p className="text-end">
            ...
            <div className="col-md-4">
              <div className="card p-3">
                <p>
                  "The seamless payment integration made me feel secure and
                  confident when booking a room."
                </p>
                <p className="text-end">
